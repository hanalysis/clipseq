process TELESCOPE_ASSIGN {
    ...
    output:
    tuple val(meta_bam), path("*updated.bam"), emit: bam, optional: true // only for --updated_sam
    tuple val(meta_bam), path("*other.bam"), emit: bam, optional: true // only for --updated_sam
    tuple val(meta_bam), path("*updated.sam"), emit: sam, optional: true // only for --updated_sam
    tuple val(meta_bam), path("*other.sam"), emit: sam, optional: true // only for --updated_sam
