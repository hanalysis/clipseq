...
workflow CLIPSEQ {
    ...
    if(params.run_reporting) {
       ...
       // MODULE: Run clipqc
        ...
        ch_multiqc_files = ch_multiqc_files.mix(COMBINE_BINS.out.csv.collect{it[1]}.ifEmpty([]))
        ...
        ch_multiqc_config = ch_multiqc_custom_config.mix(COMBINE_BINS.out.config.collect().ifEmpty([]))
